 ...
 * @group custom_field
 */
class MultiValueAjaxAddMoreTest extends WebDriverTestBase {
  ...
  public function testAddMore(): void {
    ...
    $dragged = $field_foo_0->find('xpath', 'ancestor::tr[contains(@class, "draggable")]//a[contains(@class, "tabledrag-handle")]');
